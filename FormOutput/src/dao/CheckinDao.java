...
public class CheckinDao {
    ...
    public List<CheckinInfo> getTraCuuCheckin(String keyword, String dateFrom, String dateTo) throws SQLException {
        ...
        // Kết nối CSDL (Đảm bảo file Database.java của bạn trỏ đúng DB 'thu_vien')
        Connection conn = Database.getConnection();

        // Câu lệnh SQL chuẩn với 'ma_phieu_gui'
        String sql = """
            SELECT
                c.ma_phieu_gui,
                c.ngay_yeu_cau,
    ...
    // Hàm kiểm tra định dạng ngày YYYY-MM-DD đơn giản
