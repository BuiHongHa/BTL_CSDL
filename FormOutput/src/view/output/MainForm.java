...
public class MainForm extends JFrame {
    ...
    private JPanel createFooterPanel() {
        ...
        btnBack.setBackground(new Color(230, 240, 255));
        btnBack.setBorder(BorderFactory.createLineBorder(new Color(32, 136, 203)));

        // 👉 SỰ KIỆN QUAY LẠI MAINVIEW
        ...
        // ===== TEXT COPYRIGHT =====
        JLabel lblFooter = new JLabel("© 2025 Hệ Thống Quản Lý Thư Viện - Phiên bản 1.0", SwingConstants.CENTER);
