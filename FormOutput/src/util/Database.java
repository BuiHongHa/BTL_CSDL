...
public class Database {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/thu_vien_test"; // Tên database là 'qltv'
    private static final String USER = "root"; // Tên đăng nhập MySQL
    private static final String PASSWORD = "123456789"; // Mật khẩu MySQL của bạn
